      ...
      <div className='doctors-container'>
        ...
        <div className="doc-card">
          {filteredDoctors.map((doc) => (
            <Card key={doc.id} sx={{ maxWidth: 345 , minWidth:300}}>
            <CardMedia
              sx={{ height: 240 }}
            ...
            <CardActions>
              <Button size="small"><Link to ={ `/dashboard/DocDetails/${doc.id}`} style={{textDecoration:'none', color:'blue', fontWeight:'500'}}>Learn More</Link></Button>
            </CardActions>
          </Card>
        ))} 
      </div>
